...
import DrawerAppNavigator from '../navTesting/DrawerNavigator';
...
describe('Testing react navigation', () => {
  ...
  test('clicking on the button that takes you back to the Home screen', async () => {
    const component = (
      <NavigationContainer>
        <DrawerAppNavigator />
      </NavigationContainer>
    ...
    const buttonInNotificationScreen = await findByText("Go back home")
    fireEvent.press(buttonInNotificationScreen)
    const newOldScreen = queryByText("Welcome!")
    expect(newOldScreen).toBeTruthy();
